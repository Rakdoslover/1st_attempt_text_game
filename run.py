...
def intro_scene():
    ...
    'starting position'.
    The general structure of the intro scene might recur through
    further scenes.
    """

    print(
        """\n The sun is scorching your beaten body as you wake to the
        \n sound of waves
        \n rolling in. Slowly you open your eyes and find yourself
        \n laying in the sand.
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'STAY'):
            print(
                ...
                \n horizon. Night falls upon the island and then
                \n sleep finds you.
            """)
            ans = 'correct'
            sys.exit("The End")
            ...
            print(
                """\n As you stand up you look around and find that
                \n you are on a small island.
                \n You can't remember how you got there and you can't
...
def beach_scene():
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'PATH'):
            print(
                """\n As you step in under the shadowy boughs you
                \n find a lush greenery.
                \n The path slithers onwards like a snake, under roots
                \n and over stones
            ...
            print(
                """\n You follow the edge of the tree line until you
                \n come across a small bay.
                \n From the small dune where you stand, you can see the
                \n outlines of a small boat
...
def shipwreck_scene():
    ...
    print(
        """
        \n Standing atop the small dune you see a new path lead off
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'INVESTIGATE'):
            print(
                """\n You descend the dune and start investigating the
                \n boat, it's old and
                \n badly damaged, you can't sail it.
                \n As you move the remains of what could once have been
                \n a sail, you find a water damaged notebook.
                \n Inside someone has scribbled '42 days' page up and
                \n page down.
                \n Beyond that nothing else cathes your eye and thus
                \n your return to the
            ...
            print(
                """\n As you step in under the shadowy boughs you find
                \n a lush greenery.
                \n The path slithers onwards like a snake, under roots
                \n and over stones as far as the eye can see.
            """)
            ans = 'correct'
            gate_scene()
        else:
...
def clearing_scene():
    ...
    print(
        """
        \n You push a heavy branch to the side and suddenly
        \n find yourself in a clearing.
        \n Flowers painted by all the colors of the rainbow grows like a
        \n carpet on the ground.
        \n In the middle of the clearing stands a short but solid oak
        \n tree, the path that you tread takes a right turn by it's foot.
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'INVESTIGATE'):
            print(
                """\n As you approach the tree you notice a cavity in it,
                \n curious as you are, you reach into it.
                \n It's empty say for one little object, you pick it up,
                \n it's small but quite heavy.
                \n In your hand lays a golden acorn, it shimmers in
                \n the sunlight, you put it in your pocket.
                \n You continue your journey into the deeper parts
                \n of the forest.
            """)
            ans = 'correct'
            gate_scene()
            ...
            print(
                """\n The lovely aroma of the flowers abruptly disappears
                \n as you pass under a large root.
...
def gate_scene():
    ...
    print(
        ...
        \n The first one reads 'I', the second reads 'VI', the third
        \n reads 'IV', the fourth reads 'III'
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'FIRST'):
            ...
            print(
                """\n When you press the second stone something clicks
                \n and the stone slowly descends into the ground.
                \n On rusted hinges the large gate squeeks open.
                \n As you pass through, the sounds of the forest
...
def pillar_scene():
    ...
    print(
        ...
        \n The greenery around you forms impenetrable walls, in the
        \n middle of the area stands a small stome pillar.
        \n The pillar bears a small engraving symbolizing an acorn, behind the
        \n pillar a tree alley forms a tunnel leading away from the small area.
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'INVESTIGATE'):
            print(
                ...
                \n Something seems out of place, put you can't put your
                \n finger on what.
            ...
            print(
                """\n The trees forming the walls of the alley tunnel are
                \n so thick that you can't see what's on the other side.
                \n As you move along, the alley suddenly bec omes very steep,
                \n you notice that you're climbing a hill.
...
def house_outer_scene():
    ...
    print(
        ...
        \n From where you're standing it looks abandoned, the single window
        \n is broken and there are small pieces of glas on the ground.
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'ENTER'):
            print(
                """\n You enter through the front door and find yourself in a
                \n small kitchen.
                \n The layer of dust indicates that nobody has been here
                \n for years.
            """)
            ans = 'correct'
            basket_scene()
            ...
            print(
                """\n You don't want to enter the old house and instead
                \n you turn and walk down the hill back to the pillar.
            """)
            ans = 'correct'
            pillar_two_scene()
        else:
...
def pillar_two_scene():
    ...
    print(
        ...
        \n Speaking of the gate, it's shut, you try to open it, but
        \n it won't budge.
        \n What du you do now?
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'INVESTIGATE'):
            print(
                """\n On the top of the pillar is an acorn-shaped hole.
                \n Something seems out of place, but you can't put your
                \n finger on what.
                \n As you can't do more you move along through the tree alley.
            """)
            house_outer_scene()
            ...
            print(
                """\n You turn around again as you make your way up the
                \n steep hill one more time.
                \n Soon enough you see the small house at the end of the
                \n tree alley.
            """)
            ans = 'correct'
            house_outer_scene()
...
def cavern_scene():
    """
    This is the function leading the player through the cavern
    after the pillar.
    """
    print(
        """
        ...
        \n Again, light reaches you further down, this time though it
        \n is daylight.
...
def basket_scene():
    ...
    print(
        """
        \n On a round table infront of the unlit fire place is a basket
        \n of golden acorns, somehow the acorns triggers a memory.
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'ACORNS'):
            print(
                """\n You grab a handful of acorns and put them into your
                \n pocket.
            ...
            print(
                ...
                \n Instinctively, you take a step backwards, where the
                \n fire place was just a second ago now stands a tunnel.
                \n It's dark inside but with your new sword you find courage,
                \n you get down on all four and crawl inside.
            """)
            ans = 'correct'
            secret_room_scene()
        else:
...
def secret_room_scene():
    ...
    print(
        ...
        \n The only light source are two lit candles on the floor, they
        \n shine their light on the wall opposite the tunnel.
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'ADAM'):
            print(
                """\n As you speak the name ADAM, a trapdoor suddenly
                \n opens up under you feet and you fall.
                \nThe fall is short as you quickly land on a chute and your
                \n descent speeds up.
                \n When the chute later comes to an end you find yourself in an
                \n underground cavern, someone seems to have been here before
                \n you as there are torches lit all across the spacious area.
            ...
            print(
                """\n As you speak the name MAYA, a trapdoor suddenly opens up
                \n under your feet and you fall.
                \n The fall is short but devastating, you find yourself at the
                \n bottom of a pit you can't get out of.
                \n As you come to the sad realization you contemplate whether
                \n it was ever a good idea to leave the beach.
            """)
            ans = 'correct'
            sys.exit("The End")
        elif (c1.upper() == 'NADYA'):
            print(
                """\n As you speak the name NADYA, a hidden door in the wall in
                \n front of you opens up, it leads downward into the darkness.
                ...
                \n You step out into a gigantic cavernous space filled to the
                \n brim with all the treasure you could aver imagine.
                \n On the other side of the enormous space you see pirate ship,
                \n you think to yourself that this must be some kind of
                \n underground hideout.
            """)
            ans = 'correct'
            gold_scene()
...
def gold_scene():
    ...
    while (ans == 'incorrect'):
        if (c1.upper() == 'SLASH'):
            print(
                """\n You slash at the pirate, he parries your slash and
                \n slashes back at you.
            ...
            print(
                """\n You thrust your sword towards the roughneck and it
                \n plunges into his belly, he lets out a roar of pain and falls
                \n to the deck.
